...
import { fromBase64Url, toBase64URL, toSignTransactionsParamsRequestMessage, toSignTransactionsResultResponseMessage } from "./api.js";
...
describe('Utils', () => {
    ...
    it('should create SignTransactionsResults ResponseMessage', () => {
        ...
        const result = algorandCrafter.addSignature(txn.encode(), expectedSignature);
